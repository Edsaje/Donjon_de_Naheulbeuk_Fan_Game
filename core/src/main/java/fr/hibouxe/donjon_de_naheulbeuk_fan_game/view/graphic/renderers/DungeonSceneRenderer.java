...
/**
 * Composant de rendu 3D spaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaacialisaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa pour la scaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaane d'exploration du Donjon (SRP).
 * Gaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaare la construction 3D des dalles, des murs massifs, des coffres et des escaliers.
 *
 * @author Hibouxe
 * @version 1.0
 */
public class DungeonSceneRenderer implements Disposable {
    ...
    public DungeonSceneRenderer(AssetProvider assetProvider, String themePath) {
        ...
        // Daaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaacoupage automatique si l'image fait 256x256 (64x64 par frame)
    ...
    public void setLeaderClass(String className) {
        if (heroTexture != null) {
            heroTexture = null; // L'AssetProvider s'occupe de la gestion maaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaamoire
        }
    ...
    public void buildScene(Dungeon dungeon, fr.hibouxe.donjon_de_naheulbeuk_fan_game.model.entity.Team team, float playerX, float playerZ, int currentFloor) {
        ...
        // (Ligne de taaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaalaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaportation supprimaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaae ici pour permettre la fluiditaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa)
                ...
                if (cell.isWalkable()) {
                    ...
                    if (cell.hasChest()) {
                        if (chestBaseModel != null && chestLidModel != null) {
                            ...
                            // Paramaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaatres de la charniaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaare du coffre (coordonnaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaes depuis Blender)
                            ...
                            float hingeY = 0.5f;     // A MODIFIER: La hauteur (Z dans Blender) de ta charniaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaare!
                            
                            // 1. Placement au centre
                            lid.transform.setToTranslation(posX + half, 0f, posZ + half);
                            // 2. Daaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaplacement sur la charniaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaare
                            ...
                            // 4. Daaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaplacement inverse
                            lid.transform.translate(0f, -hingeY, -hingeZ);
                        ...
                        itemSprite.setTextureRegion(chestRegion); // TODO: Utiliser un sprite spaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaacifique pour l'item
                    ...
                    if (cell.hasDoor() && doorFrameModel != null && doorModel != null) {
                        ...
                        float hingeX = 0.493241f; // Coordonnaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaae X de la charniaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaare dans Blender
                        ...
                        // 3. Daaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaplacement sur la charniaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaare locale
                        ...
                        // 5. Daaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaplacement inverse pour ramener la gaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaomaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaatrie de la porte
                        door.transform.translate(-hingeX, 0f, 0f);
                    ...
                    if (cell.hasStairs()) {
                        ...
                        entityBillboards.add(stairsSprite);
                                ...
                                // SCRIPT ELFE (Tutoriel - aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaatage 2)
        ...
        // --- Positionnement du Joueur (Haaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaros) ---
    ...
    public void render(ModelBatch modelBatch, DecalBatch decalBatch, Environment environment, PerspectiveCamera camera, float playerX, float playerZ, int playerDirection, java.util.List<fr.hibouxe.donjon_de_naheulbeuk_fan_game.model.dungeon.RoamingMonsterGroup> roamingMonsters) {
        ...
        // Vitesse d'animation ajustaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaae (8) proportionnellement au mouvement
    ...
    public void dispose() {
        ...
        // Les textures heroTexture, monsterTexture, chestTexture, stairsTexture sont gaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaraaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaes par l'AssetProvider
    }
}
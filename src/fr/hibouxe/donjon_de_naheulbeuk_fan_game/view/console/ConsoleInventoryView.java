 ...
 */
public class ConsoleInventoryView {

    public void displayInventory(Team team, ConsoleMenu menu) {
    ...
    public EquipmentSlot askSlotToUnequip(ConsoleMenu menu) {
    ...
    public boolean askUseItem(ConsoleMenu menu) {

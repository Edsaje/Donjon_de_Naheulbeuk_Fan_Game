 ...
 * @version 1.0
 */
public class ConsoleDungeonView {
     ...
     */
    public String askPlayerMovement(ConsoleMenu menu) {
     ...
     */
    public boolean askPickupItem(Item item, ConsoleMenu menu) {
     ...
     * @param ConsoleMenu La vue principale (Injectée)
     */
    public void display(Dungeon maze, Team team, ConsoleMenu menu) {

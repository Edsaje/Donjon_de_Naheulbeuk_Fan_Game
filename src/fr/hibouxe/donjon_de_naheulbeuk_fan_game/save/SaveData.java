...
/**
 * Conteneur de données pour la sérialisation des sauvegardes (QuickSave Donjon et Save Normale Hub).
 *
 * @author Hibouxe
 * @version 1.0
 */
public class SaveData implements Serializable {
     ...
     * @param dungeon      Le labyrinthe du donjon (null si sauvegarde au Hub)
     * @param currentFloor L'étage actuel
     * @param isQuickSave  true si c'est une QuickSave temporaire de donjon, false si c'est une sauvegarde du Hub
     */

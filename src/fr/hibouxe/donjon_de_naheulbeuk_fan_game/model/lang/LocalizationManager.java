...
public class LocalizationManager {
    ...
    public static void loadLanguage(String langCode) {
        ...
        try {
            ...
            File file = new File("src/assets/lang/dialogues_" + langCode + ".properties");
            if (file.exists()) {
                ...
                InputStream in = LocalizationManager.class.getResourceAsStream("/assets/lang/dialogues_" + langCode + ".properties");
                if (in != null) {
